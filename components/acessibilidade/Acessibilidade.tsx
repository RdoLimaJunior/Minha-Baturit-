  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Acessibilidade</h2>
      </div>

      <Card>
        <h3 className="text-lg font-bold text-gray-800 mb-3">Tamanho da Fonte</h3>
        <div className="text-center mb-4">
            <p className="text-gray-600">Tamanho atual: <span className="font-bold">{FONT_SIZE_LABELS[fontSize]}</span></p>
        </div>
