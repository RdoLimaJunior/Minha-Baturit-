...
const ConsultaCard: React.FC<{ consulta: ConsultaPublica, onClick: () => void }> = ({ consulta, onClick }) => {
    ...
    return (
        <Card onClick={onClick} className="!p-0">
            <img src={consulta.imageUrl} alt={consulta.title} className="w-full h-40 object-cover bg-gray-200" />
            <div className="p-4">
                <h3 className="font-bold text-lg text-gray-800">{consulta.title}</h3>
                <p className="text-sm text-gray-600 mt-1 line-clamp-2">{consulta.summary}</p>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Consultas Públicas</h2>
      </div>
      ...
      {loading ? (
        ...
        <Card className="text-center py-10">
            <Icon name="upcoming" className="text-5xl text-gray-400 mx-auto" />
            <h3 className="text-xl font-bold text-gray-800 mt-4">Nenhuma Consulta Ativa</h3>
